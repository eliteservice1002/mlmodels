...
main.py -->  
   ...
   Retunr_data(dataset.py)  64 x 64 is supported.





python main.py --seed 1 --lr 1e-4 --beta1 0.9 --beta 0.999 \
    --objective H --model H --batch_size 64 --z_dim 10 --max_iter 1.5e6 --beta 4 \
    --viz_name sinus_H_beta4_z10 \
    --dataset sinus   --dset_dir /.../adata/sinus/100_50/




Image of 64pixels x 64pixels

    #### Cosinus level
    elif name.lower() == 'sinus':
        root = os.path.join(dset_dir, 'sinus')
